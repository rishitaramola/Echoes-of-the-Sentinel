...
public class GameWindow extends JFrame {
    ...
    private JButton pauseBtn, resumeBtn, restartBtn, backBtn;
    ...
    public GameWindow() {
        ...
        backBtn.addActionListener(e -> {
            ...
            if (gamePanel != null && !gamePanel.isPaused() && gsm.getCurrentState() != GameState.RIDDLE_STASIS) {
                wasPaused = true;
                gamePanel.pauseGame();
            }
            ...
            int choice = JOptionPane.showConfirmDialog(
                    this,
                    "Are you sure you want to quit the current game and return to the Main Menu?",
                    "Quit to Menu?",
